...
const RecommendationImplementationModal = ({ 
  ...
  const generateAtRiskPunchCardImplementation = () => {
    return {
      title: 'At Risk Segment Optimization',
      type: 'Segment Enhancement',
      audience: 'At Risk Segment',
      description: 'Re-engage At Risk customer segment with punch card that incentivizes purchase frequency and recency, requiring at least one purchase per week for the next month.',
